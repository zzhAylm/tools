...
public class ProcessorApi {
    ...
    static class TotalPriceOrderProcessorSupplier implements ProcessorSupplier<String, String, String, Double> {
        ...
        @Override
        public Processor<String, String, String, Double> get() {
