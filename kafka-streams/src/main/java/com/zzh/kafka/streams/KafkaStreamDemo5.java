...
/**
 * @Description: stateful , groupByKey() count()
 * @Author: zzh
 * @Crete 2022/11/23 22:10
 */
@Slf4j
public class KafkaStreamDemo5 {
    static {
    ...
    public static void main(String[] args) {
        ...
        streamsBuilder.stream(INPUT_TOPIC,Consumed.with(Serdes.String(), Serdes.String()).withName("input-word-stream"))
                ...
                .count(Named.as("word-count-processor"), Materialized.as("word-count-table"))
                .toStream()
                .print(Printed.<String,Long>toSysOut().withLabel("word-count-print"));
